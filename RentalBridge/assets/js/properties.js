...
// Property data structure template
...
const initSampleProperties = () => {
    ...
    const properties = storedProps ? JSON.parse(storedProps) : [];
    ...
    if (properties.length === 0) {
        const indianProperties = [
            ...
            },
            {
                ...
                images: ['https://images.unsplash.com/photo-1502672260066-6bc54fc99ebe?auto=format&fit=crop&w=800&q=80'],
            ...
            },
            {
                ...
                furnished: 'unfurnished',
                amenities: ['parking'],
                images: ['https://images.unsplash.com/photo-1522771731478-44eb10e5c2d0?auto=format&fit=crop&w=800&q=80'],
...
const validatePropertyData = (data) => {
    ...
    if (!data.rent || data.rent <= 0) {
        errors.push('Valid rent required');
    }
